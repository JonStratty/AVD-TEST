...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.255.165/24 | 192.168.255.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE-1_Ethernet5 | routed | - | 172.31.1.1/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE-2_Ethernet5 | routed | - | 172.31.1.3/31 | default | 1500 | false | - | - |
...
router bgp 65103
   ...
   neighbor 172.31.1.0 description spine-1_Ethernet5
   neighbor 172.31.1.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.1.2 remote-as 65001
   neighbor 172.31.1.2 description spine-2_Ethernet5
