...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.255.162/24 | 192.168.255.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK_1 | Vlan4094 | 172.31.255.0 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet11 | MLAG_PEER_leaf-1a_Ethernet11 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_leaf-1a_Ethernet12 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE-1_Ethernet2 | routed | - | 172.31.1.5/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE-2_Ethernet2 | routed | - | 172.31.1.7/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_SPINE-1_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_SPINE-2_Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet11
   description MLAG_PEER_leaf-1a_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_leaf-1a_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel11 | MLAG_PEER_leaf-1a_Po11 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_leaf-1a_Po11
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  172.31.128.1/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.255.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.31.1.4 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.31.1.6 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.31.128.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
router bgp 65101
   ...
   neighbor 172.31.1.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.1.4 remote-as 65001
   neighbor 172.31.1.4 description spine-1_Ethernet2
   neighbor 172.31.1.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.1.6 remote-as 65001
   neighbor 172.31.1.6 description spine-2_Ethernet2
   neighbor 172.31.128.0 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.31.128.0 description leaf-1a
