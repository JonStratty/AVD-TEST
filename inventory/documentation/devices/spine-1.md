...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.255.151/24 | 192.168.255.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_LEAF-1A_Ethernet1 | routed | - | 172.31.1.0/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_LEAF-1B_Ethernet1 | routed | - | 172.31.1.4/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_LEAF-2A_Ethernet1 | routed | - | 172.31.1.0/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_LEAF-2B_Ethernet1 | routed | - | 172.31.1.4/31 | default | 1500 | false | - | - |
| Ethernet5 | P2P_LINK_TO_LEAF-3A_Ethernet1 | routed | - | 172.31.1.0/31 | default | 1500 | false | - | - |
| Ethernet7 | P2P_LINK_TO_LEAF-4A_Ethernet1 | routed | - | 172.31.1.0/31 | default | 1500 | false | - | - |
| Ethernet9 | P2P_LINK_TO_LEAF-9A-SVC_Ethernet1 | routed | - | 172.31.1.0/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_LEAF-1A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_LEAF-1B_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_LEAF-2A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.1.0/31
...
!
interface Ethernet4
   description P2P_LINK_TO_LEAF-2B_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.1.4/31
...
!
interface Ethernet5
   description P2P_LINK_TO_LEAF-3A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.1.0/31
...
!
interface Ethernet7
   description P2P_LINK_TO_LEAF-4A_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.1.0/31
...
!
interface Ethernet9
   description P2P_LINK_TO_LEAF-9A-SVC_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 172.31.1.0/31
...
| 172.31.1.1 | 65109 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.31.1.5 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
router bgp 65001
   ...
   neighbor 172.31.1.1 remote-as 65109
   neighbor 172.31.1.1 description leaf-9a-SVC_Ethernet1
   neighbor 172.31.1.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.1.5 remote-as 65102
   neighbor 172.31.1.5 description leaf-2b_Ethernet1
