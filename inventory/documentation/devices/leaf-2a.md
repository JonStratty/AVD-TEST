...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.255.163/24 | 192.168.255.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK_2 | Vlan4094 | 172.31.255.1 | Port-Channel11 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet11 | MLAG_PEER_leaf-2b_Ethernet11 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
| Ethernet12 | MLAG_PEER_leaf-2b_Ethernet12 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 11 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE-1_Ethernet3 | routed | - | 172.31.1.1/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE-2_Ethernet3 | routed | - | 172.31.1.3/31 | default | 1500 | false | - | - |
...
interface Ethernet11
   description MLAG_PEER_leaf-2b_Ethernet11
   no shutdown
   channel-group 11 mode active
!
interface Ethernet12
   description MLAG_PEER_leaf-2b_Ethernet12
   no shutdown
   channel-group 11 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel11 | MLAG_PEER_leaf-2b_Po11 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel11
   description MLAG_PEER_leaf-2b_Po11
   no shutdown
   switchport
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan4093 |  default  |  172.31.128.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.255.0/31  |  -  |  -  |  -  |  -  |  -  |
