...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.255.191/24 | 192.168.255.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE-1_Ethernet9 | routed | - | 172.31.1.1/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SPINE-2_Ethernet9 | routed | - | 172.31.1.3/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_SPINE-1_Ethernet9
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_SPINE-2_Ethernet9
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65109
   ...
   neighbor 172.31.1.0 description spine-1_Ethernet9
   neighbor 172.31.1.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.1.2 remote-as 65001
   neighbor 172.31.1.2 description spine-2_Ethernet9
